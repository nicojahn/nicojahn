...
🔭 I'm currently working on <!-- projects -->repository [nicojahn/hyper-scale-tensorflow-with-minio](https://github.com/nicojahn/hyper-scale-tensorflow-with-minio) which was updated 10 days ago and is mainly written in Python as well as repository [nicojahn/pymooney](https://github.com/nicojahn/pymooney) which was updated 13 days ago and is mainly written in Python<!-- projects -->.
