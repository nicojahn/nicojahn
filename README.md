...
Hi! My name is <!-- name -->Nico Jahn<!-- name --> and right now it's <!-- date -->Wednesday, 25 February 2026, CET<!-- date --> in <!-- city -->Berlin<!-- city -->.

🔭 I'm currently working on <!-- projects -->repository [nicojahn/amazon-bedrock-agentcore-samples](https://github.com/nicojahn/amazon-bedrock-agentcore-samples) which was updated 109 days ago and is mainly written in Jupyter Notebook<!-- projects -->.
