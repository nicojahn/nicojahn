...
Hi! My name is <!-- name -->Nico Jahn<!-- name --> and right now it's <!-- date -->Wednesday, 12 November 2025, CET<!-- date --> in <!-- city -->Berlin<!-- city -->.

🔭 I'm currently working on <!-- projects -->repository [nicojahn/amazon-bedrock-agentcore-samples](https://github.com/nicojahn/amazon-bedrock-agentcore-samples) which was updated 4 days ago and is mainly written in Jupyter Notebook<!-- projects -->.
