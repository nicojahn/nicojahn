...
Hi! My name is <!-- name -->Nico Jahn<!-- name --> and right now it's <!-- date -->Thursday, 18 December 2025, CET<!-- date --> in <!-- city -->Berlin<!-- city -->.

🔭 I'm currently working on <!-- projects -->repository [nicojahn/amazon-bedrock-agentcore-samples](https://github.com/nicojahn/amazon-bedrock-agentcore-samples) which was updated 41 days ago and is mainly written in Jupyter Notebook<!-- projects -->.
