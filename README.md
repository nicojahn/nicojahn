...
Hi! My name is <!-- name -->Nico Jahn<!-- name --> and right now it's <!-- date -->Saturday, 09 August 2025, CEST<!-- date --> in <!-- city -->Berlin<!-- city -->.

🔭 I'm currently working on <!-- projects -->repository [nicojahn/bot](https://github.com/nicojahn/bot) which was updated 10 days ago and is mainly written in Python<!-- projects -->.
