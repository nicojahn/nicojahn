...
Hi! My name is <!-- name -->Nico Jahn<!-- name --> and right now it's <!-- date -->Tuesday, 16 December 2025, CET<!-- date --> in <!-- city -->Berlin<!-- city -->.

🔭 I'm currently working on <!-- projects -->repository [nicojahn/amazon-bedrock-agentcore-samples](https://github.com/nicojahn/amazon-bedrock-agentcore-samples) which was updated 38 days ago and is mainly written in Jupyter Notebook<!-- projects -->.
